...
$(1).pass-1.log: $(EXE)
	...
	&& $(EXE) -D $(1) -p $(DATA) -c -m lazy -n $(N)0 -B get,iterate,crud -w 1 -r 4 -C $(CSV)/pass1- $(LOGOUT) run.txt \
...
$(1).pass-2.log: $(EXE)
	...
	&& $(EXE) -D $(1) -p $(DATA) -c -m nosync -n $(N)00 -B get,iterate,crud -w 1 -r 4 -C $(CSV)/pass2- $(LOGOUT) run.txt \
	&& $(EXE) -D $(1) -p $(DATA) -c -m nosync -n $(N)00 -B get,iterate -r 1 -C $(CSV)/passR1- $(LOGOUT) run.txt \
	&& $(EXE) -D $(1) -p $(DATA) -c -m nosync -n $(N)00 -B get,iterate -r 2 -C $(CSV)/passR2- $(LOGOUT) run.txt \
	&& $(EXE) -D $(1) -p $(DATA) -c -m nosync -n $(N)00 -B get,iterate -r 4 -C $(CSV)/passR4- $(LOGOUT) run.txt \
	&& $(EXE) -D $(1) -p $(DATA) -c -m nosync -n $(N)00 -B get,iterate -r 8 -C $(CSV)/passR8- $(LOGOUT) run.txt \
...
$(1).pass-3.log: $(EXE)
	...
	&& $(EXE) -D $(1) -p $(DATA) -c -m sync -n $(N) -B get,iterate,crud -w 1 -r 4 -C $(CSV)/pass3- $(LOGOUT) run.txt \
