...
macro(build_nessdb)
    ...
    if (${PROJECT_BINARY_DIR} STREQUAL ${PROJECT_SOURCE_DIR})
		add_custom_command(OUTPUT ${PROJECT_SOURCE_DIR}/db/nessdb/libnessdb.so
		...
		add_custom_command(OUTPUT ${PROJECT_BINARY_DIR}/db/nessdb/libnessdb.so
	...
	add_custom_target(libnessdb ALL
		DEPENDS ${PROJECT_BINARY_DIR}/db/nessdb//libnessdb.so
	)
    message(STATUS "Use shipped nessDB: ${PROJECT_SOURCE_DIR}/db/nessdb")
    set (NESSDB_LIBRARIES "${PROJECT_BINARY_DIR}/db/nessdb/libnessdb.so")
    set (NESSDB_FOUND 1)
