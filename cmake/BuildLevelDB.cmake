...
macro(build_leveldb)
	...
	if (${PROJECT_BINARY_DIR} STREQUAL ${PROJECT_SOURCE_DIR})
		add_custom_command(
			OUTPUT ${PROJECT_BINARY_DIR}/db/leveldb/libleveldb.so.1
			COMMAND ${CMAKE_MAKE_PROGRAM} -j ${MAKE_NJOB} ${LEVELDB_OPTS} -C ${PROJECT_BINARY_DIR}/db/leveldb libleveldb.so.1 libleveldb.so
	...
	add_custom_target(libleveldb ALL
		DEPENDS ${PROJECT_BINARY_DIR}/db/leveldb/libleveldb.so.1
	)
	message(STATUS "Use shipped LevelDB: ${PROJECT_SOURCE_DIR}/db/leveldb")
	set (LEVELDB_LIBRARIES "${PROJECT_BINARY_DIR}/db/leveldb/libleveldb.so.1")
	set (LEVELDB_FOUND 1)
