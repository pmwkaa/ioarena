...
macro(build_rocksdb)
	...
	if (${PROJECT_BINARY_DIR} STREQUAL ${PROJECT_SOURCE_DIR})
		add_custom_command(
			OUTPUT ${PROJECT_BINARY_DIR}/db/rocksdb/librocksdb.so.3
	...
	add_custom_target(librocksdb ALL
		DEPENDS ${PROJECT_BINARY_DIR}/db/rocksdb/librocksdb.so.3
	)
	message(STATUS "Use shipped RocksDB: ${PROJECT_SOURCE_DIR}/db/rocksdb")
	set (ROCKSDB_LIBRARIES "${PROJECT_BINARY_DIR}/db/rocksdb/librocksdb.so.3" bz2 z)
	set (ROCKSDB_FOUND 1)
